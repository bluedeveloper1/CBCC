...
<div class="container-fluid">
    <div class="animated fadeIn">
        ...
        <div class="row">
                ...
                <table class="table table-responsive-sm table-outline white-bg">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-sm rounded"><i class="fa fa-id-card-o"></i></button>
                                <button type="button" class="btn btn-warning btn-sm rounded"><i class="fa fa-pencil-square-o"></i></button>
                                <button type="button" class="btn btn-danger btn-sm rounded"><i class="fa fa-times-rectangle"></i></button>
                            </td>
                        </tr>
                        <tr>
                            <td>Lingo</td>
                            ...
                            <td>Justan</td>
                            <td>2012/02/01</td>
                            <td><span class="badge badge-danger">Visitor</span></td>
                            <td>
                                <button type="button" class="btn btn-primary btn-sm rounded"><i class="fa fa-id-card-o"></i></button>
                                <button type="button" class="btn btn-warning btn-sm rounded"><i class="fa fa-pencil-square-o"></i></button>
                                <button type="button" class="btn btn-danger btn-sm rounded"><i class="fa fa-times-rectangle"></i></button>
                                ...
                                <div class="col-md-12">
                                    <div class="card-body">
                                        ...
                                        <div class="row">                    
                                            ...
                                            <div class="form-group col-sm-4">
                                                <input class="form-control" type="text" id="course" placeholder="Course">
                                            </div>
                                            <div class="form-group col-sm-2">
            ...
            <div class="modal fade" id="visitorModal" tabindex="-1" role="dialog" aria-labelledby="myVisitorModal" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
